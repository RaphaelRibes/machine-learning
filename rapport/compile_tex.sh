...
pdflatex --shell-escape -interaction=nonstopmode -output-directory="$OUTDIR" "$TEXFILE"
if [ $? -ne 0 ]; then
...
if [ $? -ne 0 ]; then
    echo "Error: Failed to move the generated PDF to the main directory."
    exit 1
fi
...
# Step 6: Open the generated PDF automatically
